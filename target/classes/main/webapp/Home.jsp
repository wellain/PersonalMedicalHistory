...
<html lang="en"> 
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <center>
			...
			<span class="h4">Worried about losing your lab reports and prescription?</span><br><br>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <p>
                                             Worried to loose your prescriptions and medical records? Worry not! Because Personal Medical History is here. Our team is committed to bring to you the<br> best platform to store your medical history with ease and security.</p>
                                </div>
                            </div>
