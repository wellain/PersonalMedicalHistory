...
* Date of Visit : <input type="date" name="dateOfVisit" placeholder="Date of Visit"><br><br>
&nbsp &nbsp &nbspNext Appointment : <input type="date" name="dateOfAppointment" placeholder="Next Appointment"><br><br><br>
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Upload Prescription: <input type="file" name="photo" size="50"/><br><br><br>
