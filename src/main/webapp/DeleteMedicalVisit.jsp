...
<body>
<center><br><H1> Delete Medical Visit </H1></center><br>
<center>
<form action="DeleteMedicalVisitServlet" method="post" name="frm" onsubmit = "return formValidation()">
<h6> Enter the details to delete a visit</h6><br>
